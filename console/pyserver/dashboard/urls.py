...
from dashboard.views.widget import (
     widget_active_operator,
     widget_schedule_view,
     widget_embed_view,
     widget_content_view,
     test_widget,
     active_operator_init_form,
     inactive_operator_init_form,
     install,
     edit_widget_contact_form_view,
     add_widget_contact_form_view,
     widget_calendar_view,
     widget_content_script_file,
     widget_embed_script_file,
)
...
urlpatterns = [
    ...
    path('widget_embed/<int:widget_id>/<str:hostname>/<slug:uuid>',
         widget_embed_view, name='widget_embed'),
    path('widget_content/<int:widget_id>',
         widget_content_view, name='widget_content'),
    path('widget_schedule/<int:widget_id>/<str:hostname>/<slug:uuid>',
         widget_schedule_view, name='widget_schedule'),
    path('widget_calendar_view/<int:widget_id>',
         widget_calendar_view, name='widget_calendar_view'),
    path('edit_widget_contact_form_view/<int:widget_id>',
         edit_widget_contact_form_view, name='edit_widget_contact_form_view'),
    path('add_widget_contact_form_view/<int:widget_id>',
         add_widget_contact_form_view, name='add_widget_contact_form_view'),
    path('widget_active_operator/<int:widget_id>/<str:hostname>/<slug:uuid>',
         widget_active_operator, name='widget_active_operator'),
    path('test_widget2', test_widget, name="test_widget"),
    path('active_operator_init_form', active_operator_init_form,
         name="active_operator_init_form"),
    path('inactive_operator_init_form', inactive_operator_init_form,
         name="inactive_operator_init_form"),
    # path('widget_embed_script/<int:widget_id>/', widget_embed_script_file, name="widget_embed_script"),
    path('widget_content_script/<int:widget_id>/',
         widget_content_script_file, name="widget_embed_content"),
    re_path(
        r'^install/(?P<widget_id>[\d]+)/(?P<domain>[\w\d\.\-\_]+)/(?P<uuid>[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12})$', install, name="install"),
]
