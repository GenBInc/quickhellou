...
urlpatterns = [
    ...
    path('widget_active_operator/<int:widget_id>/<str:hostname>/<slug:uuid>', views.widget_active_operator, name='widget_active_operator'),
    path('test_widget', views.test_widget, name="test_widget"),    
    path('active_operator_init_form', views.active_operator_init_form, name="active_operator_init_form"),    
    path('inactive_operator_init_form', views.inactive_operator_init_form, name="inactive_operator_init_form"),    
