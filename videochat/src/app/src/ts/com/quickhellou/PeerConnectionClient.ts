...
export class PeerConnectionClient extends FormService {
  ...
  public init(): Promise<void> {
    return new Promise((resolve: any) => {
      ...
      this.peerConnection.onstatsended = (message): void => {
   ...
   * @memberof PeerConnectionClient
   */
  public receiveSignalingMessage(message: any): void {
  ...
  /**
   * Returns true if send message using GAE channel.
   *
   * @public
   * @returns {boolean}
   * @memberof PeerConnectionClient
   */
  public sendAsGaeMessage(): boolean {
